...
void loop() {
  ...
  {
    ResultCommadTranslation = getStraightTranslation(RIGHTMdist, LEFTMdist);
  ...
  Serial.print(" - " + String(counter) + " RIGHT " + " + " + String(counter2) + " LEFT " + String(pastCounter) + " R " + String(pastCounter2) + " L" + " Sum: " + String(RIGHTMdist2) + " R " + String(LEFTMdist2) + " L ");
  delay(30);
  Serial.println();
}
