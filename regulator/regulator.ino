...
void doMove(uint32_t speed_left,uint32_t speed_right,uint32_t dist_left,uint32_t dist_right)
{
  while (dist_left < gLeftCounter && dist_right < gRightCounter){
