...
ISR(TIMER1_OVF_vect) {
  ...
  int32_t lcontrol_right_slave = error_right_slave * kp_right_slave + error_d_right_slave * kd_right_slave + error_i_right_slave * ki_right_slave;
  lcontrol_right = lcontrol_right + lcontrol_right_slave;
  if (lcontrol_left <= 0) {
    //reverse
